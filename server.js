...
import handleChatSocket from "./src/common/socket/chat.socket.js";
import handleNotificationSocket from "./src/common/socket/notification.js";
 ...
 * npx sequelize-auto -h localhost -d db_cyber -u root -x 1234 -p 3307  --dialect mysql -o src/models -a src/models/additional.json
 */
