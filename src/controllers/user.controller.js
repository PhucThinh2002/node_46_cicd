...
export const userController = {
   ...
   uploadLocal: async function (req, res, next) {
    try {
       const result = await userService.uploadLocal(req);
   ...
   uploadCloud: async function (req, res, next) {
      try {
         const result = await userService.uploadCloud(req);
